...
(function (global, factory) {
	...
	var asyncStream = createCommonjsModule(function (module, exports) {
	 ...
	 */
	var pad = function pad(plaintext) {
	...
	var decrypter = createCommonjsModule(function (module, exports) {
	  ...
	  var _aes2 = _interopRequireDefault(aes);

	  var _asyncStream2 = _interopRequireDefault(asyncStream);
	  ...
	  var Decrypter = function () {
	    function Decrypter(encrypted, key, initVector, done) {
	      ...
	      this.asyncStream_.push(function () {
	        ...
	        done(null, (0, pkcs7.unpad)(decrypted));
	      });
	    }
	...
	unwrapExports(decrypter);
	var decrypter_1 = decrypter.decrypt;
	var decrypter_2 = decrypter.Decrypter;
	...
	var aesDecrypter = unwrapExports(es5);
	...
	var Decrypter = new shimWorker("./decrypter-worker.worker.js", function (window, document) {
	   ...
	   */
			...
			var Decrypter = aesDecrypter.Decrypter;
	...
	var Decrypter$1 = aesDecrypter.Decrypter,
